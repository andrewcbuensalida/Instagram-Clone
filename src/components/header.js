					...
					<div className="text-gray-700 text-center flex items-center align-items cursor-pointer">
						<h1>
							<Link to={ROUTES.DASHBOARD} aria-label="Dashboard">
								<img
									src={
										"https://firebasestorage.googleapis.com/v0/b/instagram-scrimba-react-tailwi.appspot.com/o/images%2Flogo.png?alt=media&token=7a8fcd98-0516-4cb9-8492-b9c0abe462dd"
									}
									alt="Instagram"
